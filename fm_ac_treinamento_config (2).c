...
struct cm_fm_config fm_ac_treinamento_config[] = {
	...
	{ AC_OP_TREINAMENTO_READ_SEARCH, "op_ac_treinamento_read_search"},
         { AC_OP_TREINAMENTO_VIEW, "op_ac_treinamento_view"},
         { AC_OP_TREINAMENTO_OPCODE_FINAL, "op_ac_treinamento_opcode_final"},
	{ 0,(char *)0 }
};
